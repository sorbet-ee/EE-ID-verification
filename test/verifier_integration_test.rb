...
class VerifierIntegrationTest < Minitest::Test
  ...
  def test_session_management_and_cleanup
    ...
    flunk "DigiDoc Local required for session management test" unless @verifier.method_available?(:digidoc_local)
  ...
  def test_error_handling_and_edge_cases
    ...
    return unless @verifier.method_available?(:digidoc_local)
  ...
  def test_concurrent_access_safety
    ...
    skip "DigiDoc Local not available for concurrency test" unless @verifier.method_available?(:digidoc_local)
  ...
  def test_method_not_available_handling
    ...
    unavailable_methods = %i[mobile_id smart_id digidoc_browser]
  ...
  def test_global_configuration
    ...
    EeIdVerification.configuration
